...
class Program
{
    static void Main(string[] args)
    {
        Employee firstOwner = new Employee
        {
            FirstName = "Иван", 
            LastName = "Иванов", 
            BirthdayDate = new DateTime(1980, 5, 10), 
            PhoneNumber = 077766699
        };
        Employee secondOwner = new Employee
        {
            FirstName = "Петр",
            LastName = "Петров", 
            BirthdayDate = new DateTime(1975, 3, 21), 
            PhoneNumber = 077854357
        };
        ...
        Client client = new Client
        {
            FirstName = "Федор", 
            LastName = "Федоров", 
            PhoneNumber = 077760235, 
            BirthdayDate = new DateTime(1999, 05, 10) 
        };
